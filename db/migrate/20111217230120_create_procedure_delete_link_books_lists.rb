class CreateProcedureDeleteLinkBooksLists < ActiveRecord::Migration
  def up
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f1_books_lists(IN v1_books_list_id BIGINT,
    ...
    CREATE PROCEDURE p_Delete_link_f2_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f3_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f4_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f5_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f6_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f7_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f8_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_link_f9_books_lists(IN v1_books_list_id BIGINT,
                                                    IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Delete_books_reviews(IN v1_isbn13 VARCHAR(255),
                                                    IN v1_debugid VARCHAR(255))
     BEGIN


	DELETE FROM books_reviews WHERE isbn = v1_isbn13;


      /* Insert a record in debug table for tracking the events */
      call debug.debug_insert(v1_debugid,concat('All the reviews present for the isbn13: ',v1_isbn13,
