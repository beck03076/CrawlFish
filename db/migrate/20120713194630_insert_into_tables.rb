class InsertIntoTables < ActiveRecord::Migration
  def up
	...
	execute "insert into branches(branch_name,city_id,created_at) values('thiruvanmiyur',1,now())"
	execute "insert into branches(branch_name,city_id,created_at) values('taramani',1,now())"
	execute "insert into branches(branch_name,city_id,created_at) values('medavakkam',1,now())"
        execute "insert into branches(branch_name,city_id,created_at) values('navalur',1,now())" 
