class InsertIntoMonetizationTables < ActiveRecord::Migration
  def up
	...
	execute "insert into monetization.cut_off_periods(cut_off_period,created_at) values(25,now())"
        execute "insert into monetization.cut_off_periods(cut_off_period,created_at) values(30,now())"
        execute "insert into monetization.cut_off_periods(cut_off_period,created_at) values(60,now())"
	...
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(500,45,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(500,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(750,45,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(750,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(1000,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(1250,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(1500,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(1750,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(2000,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(2250,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(2500,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(2750,30,now())"
	execute "insert into monetization.fixed_pays(subscription_cost,subscription_period,created_at) values(3000,30,now())"
	...
	execute "insert into monetization.product_purchase_commissions(product_purchase_commissions,created_at) values(1.5,now())"
