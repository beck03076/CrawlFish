class CreateProcedureInsertUpdateLinkMobilesLists < ActiveRecord::Migration
  def up
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f1_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f1_mobiles_lists
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f2_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f2_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f3_mobiles_lists(IN v1_mobiles_list_id BIGINT,
                                                  IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f4_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f4_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f5_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f5_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f5_c_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f5_c_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f6_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f6_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f7_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f7_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f8_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f8_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f9_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f9_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f10_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f10_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f11_mobiles_lists(IN v1_mobiles_list_id BIGINT,
     ...
     DELETE FROM link_f11_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f12_mobiles_lists(IN v1_mobiles_list_id BIGINT,
                                                  IN v1_debugid VARCHAR(255))
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f13_mobiles_lists(IN v1_mobiles_list_id BIGINT,
                                                  IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f14_mobiles_lists(IN v1_mobiles_list_id BIGINT,
	...
	call debug.debug_insert(v1_debugid,'Record is not inserted into link_f14_mobiles_lists');
     ...
     DELETE FROM link_f14_mobiles_lists
     WHERE mobiles_list_id = v1_mobiles_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f15_mobiles_lists(IN v1_mobiles_list_id BIGINT,
                                                  IN v1_debugid VARCHAR(255))
     BEGIN
