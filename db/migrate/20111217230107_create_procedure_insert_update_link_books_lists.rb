class CreateProcedureInsertUpdateLinkBooksLists < ActiveRecord::Migration
  def up
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f1_books_lists(IN v1_books_list_id BIGINT,
    ...
    END;
     ...
     execute <<-SQL
     CREATE PROCEDURE p_Insert_link_f2_books_lists(IN v1_books_list_id BIGINT,
                                                   IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f3_books_lists(IN v1_books_list_id BIGINT,
                                                  IN v1_isbn_id INT,
                                                  IN v1_debugid VARCHAR(255))
     BEGIN
   ...
   execute <<-SQL
   CREATE PROCEDURE p_Insert_link_f4_books_lists(IN v1_books_list_id BIGINT,
                                                  IN v1_isbn13_id INT,
                                                  IN v1_debugid VARCHAR(255))
     BEGIN
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f5_books_lists(IN v1_books_list_id BIGINT,
     ...
     DELETE FROM link_f5_books_lists
     WHERE books_list_id = v1_books_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f6_books_lists(IN v1_books_list_id BIGINT,
     ...
     DELETE FROM link_f6_books_lists
     WHERE books_list_id = v1_books_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f7_books_lists(IN v1_books_list_id BIGINT,
     ...
     DELETE FROM link_f7_books_lists
     WHERE books_list_id = v1_books_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f8_books_lists(IN v1_books_list_id BIGINT,
     ...
     DELETE FROM link_f8_books_lists
     WHERE books_list_id = v1_books_list_id;
    ...
    execute <<-SQL
    CREATE PROCEDURE p_Insert_link_f9_books_lists(IN v1_books_list_id BIGINT,
     ...
     DELETE FROM link_f9_books_lists
     WHERE books_list_id = v1_books_list_id;
