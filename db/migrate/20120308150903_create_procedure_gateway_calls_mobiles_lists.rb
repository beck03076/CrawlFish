...
def up
    ...
    execute <<-SQL
    CREATE PROCEDURE p_gateway_calls_mobiles_lists(IN v3_product_id BIGINT,
    ...
    FROM mobiles_lists
    WHERE mobile_name = v3_product_name
    LIMIT 1;
