class CreateProcedureInsertIntoLinkProductsListsVendors < ActiveRecord::Migration
  def up
    ...
    CREATE PROCEDURE p_Insert_delete_uniqueid(IN v1_debug_id VARCHAR(255),
     ...
     DECLARE v1_product_sub_category_id,v1_vid_pid INT;
      
     SET v1_vid_pid = CONCAT(v1_vendor_id,v1_pid);
    ...
    AND products_list_id = v1_products_list_id 
    AND sub_category_id = v1_product_sub_category_id
    AND pid = v1_vid_pid;


    IF v_COUNTLinksproductsVendorsID <>0  AND v1_delete_flag = 1 THEN
        call debug.debug_insert("######==SCENARIO==######","######==DELETE==######");
    ...
    ELSEIF v_COUNTLinksproductsVendorsID = 0 AND v1_delete_flag = 0 THEN
        ...
        call debug.debug_insert("######==SCENARIO==######","######==INSERT==######");
    ...
    SET FOREIGN_KEY_CHECKS = 0;
       ...
       INSERT INTO link_products_lists_vendors(vendor_id,
                                               products_list_id,
                                               sub_category_id,
                                               availability_id,
                                               pid,
    ...
    call debug.debug_insert("######==SCENARIO==######","######==UPDATE==######");
