...
vendor_address,latitude,longitude,city_name,branch_name,working_time,miscellaneous,vendor_sub_categories,monetization_type,subscribed_date,trial_flag,created_at) values('<<capitalized_vendor_name>>','<<vendor_logo>>','<<vendor_description>>','<<business_type>>','<<vendor_website>>','<<vendor_email>>','<<vendor_phone>>','<<vendor_fax>>', '<<vendor_address>>','<<latitude>>','<<longitude>>','<<city_name>>','<<branch_name>>','<<working_time>>','<<miscellaneous>>',
'<<sub_categories>>','<<monetization_type>>','<<subscribed_date>>','<<trial_flag>>',now());
